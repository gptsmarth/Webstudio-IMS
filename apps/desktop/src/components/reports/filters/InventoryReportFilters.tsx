    ...
    <>
      ...
      <label className="report-builder__field">
        ...
        <select
          ...
          onChange={(e) => setFilters({ inventoryStatus: e.target.value as typeof filters.inventoryStatus })}
        >
      ...
      <label className="report-builder__field">
        <span>Color</span>
        <input className="input" value={filters.color} onChange={(e) => setFilters({ color: e.target.value })} />
      </label>
