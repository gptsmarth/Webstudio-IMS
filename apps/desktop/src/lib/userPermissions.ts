...
const PERMISSION_REGISTRY: PermissionMetadata[] = [
  ...
  { permission: 'brands:delete', label: 'Delete brands', description: 'Permanently delete brands without dependencies', module: 'catalogue', i18nKey: 'permission.brands.delete' },
  ...
  { permission: 'product_models:delete', label: 'Delete models', description: 'Permanently delete product models without inventory', module: 'catalogue', i18nKey: 'permission.product_models.delete' },
  ...
  { permission: 'locations:delete', label: 'Delete locations', description: 'Permanently delete locations after inventory transfer', module: 'catalogue', i18nKey: 'permission.locations.delete' },
