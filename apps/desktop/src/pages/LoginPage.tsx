...
export const LoginPage: React.FC<Props> = ({
    ...
    try {
      ...
      setRecoverError(
        errorObj.response?.data?.detail ??
          'Invalid recovery key. Please check the code and try again.',
      );
    }
  };
  ...
  const handleRecoveryKeyAcknowledged = () => {
    ...
    closeRecovery();
    setError(
      'Password reset complete. A new recovery key was generated — store it safely. Sign in with your new password.',
    );
    setFailedAttempts(0);
  };
        ...
        <div style={{ width: '100%', maxWidth: 400 }}>
          ...
          {lockoutSeconds > 0 && (
            <div
              ...
              style={{ marginBottom: 20, animation: 'fadeIn 150ms ease-out both' }}
            >
              ...
              {recoveryPhase === 'credentials' ? (
                ...
                >
                  <div className="alert alert-info">
                    <AlertCircle size={14} style={{ flexShrink: 0, marginTop: 1 }} />
                    <span>
                      Enter the 24-character master key to authenticate and update your password.
                    </span>
                  </div>
