...
class Sale(Base, PrimaryKeyMixin):
    ...
    sale_cgst_amount: Mapped[float | None] = mapped_column(Numeric(12, 2), nullable=True)
    sale_sgst_amount: Mapped[float | None] = mapped_column(Numeric(12, 2), nullable=True)
    sale_igst_amount: Mapped[float | None] = mapped_column(Numeric(12, 2), nullable=True)
    sale_cess_amount: Mapped[float | None] = mapped_column(Numeric(12, 2), nullable=True)
