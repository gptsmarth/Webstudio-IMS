...
async def clean_notification_tables(db_session: AsyncSession) -> None:
    await db_session.execute(
        text(
            "TRUNCATE TABLE webstudio.notifications, webstudio.audit_logs, webstudio.sales, "
            "webstudio.inventory_items, webstudio.product_models, webstudio.locations, "
            "webstudio.brands, webstudio.refresh_tokens, webstudio.users, webstudio.system_settings "
